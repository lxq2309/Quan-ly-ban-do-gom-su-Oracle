                            ...
                            <ul class="nav nav-treeview" style="display: block;">
                                <li class="nav-item">
                                    <a href="{{ route('employee.index') }}"
                                        class="nav-link {{ set_active('employee.*') }}">
                            ...
                            <ul class="nav nav-treeview" style="display: block;">
                                <li class="nav-item">
                                    <a href="{{ route('product.index') }}"
                                        class="nav-link {{ set_active('product.*') }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>
                                            Sản phẩm
                                        </p>
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('productset.index') }}"
                                        class="nav-link {{ set_active('productset.*') }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>
                                            Bộ sản phẩm
                                        </p>
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('color.index') }}"
                                        class="nav-link {{ set_active('color.*') }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>
                                            Màu sắc
                                        </p>
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('glaze.index') }}"
                                        class="nav-link {{ set_active('glaze.*') }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>
                                            Loại men
                                        </p>
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('country.index') }}"
                                        class="nav-link {{ set_active('country.*') }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>
                                            Nước sản xuất
                                        </p>
